...
function installAll() {
  ...
  echo "$(tput setaf 6)Cloning the latest stuff code..."
  git reset --hard HEAD
  git pull
  echo "$(tput setaf 2)Cloned latest version of the stuff."
  echo "$(tput setaf 6)Installing stuff dependencies..."
  npm install &> /dev/null
  echo "$(tput setaf 2)Installed stuff dependencies."
  echo "$(tput setaf 2)Running stuff..."
